...
public class C01 {
    ...
    public static void main(String[] args) {
        ...
        static variable lar tüm class tan kullanılabilirken
        instance olanlar sadece static olmayan method larda direk kullanılabilir
        instance variable lara static method dan ulasmak istersek
        obje olusturmamiz gerekir.

        instance variable lar obje variable ı oldugu icin
        herhangi bir satirda instance variable ın degerinin ne oldugunu bulmak icin
