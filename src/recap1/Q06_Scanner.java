...
public class Q06_Scanner {
    ...
    */
      public static void main(String[] args) {
          ...
          double birIsciBitirmeSüresi = scan.nextDouble();

          System.out.println("toplam kaç işci çalışacak :");
          double isci_Sayisi = scan.nextDouble();

          double cokluBitirmeSüresi = birIsciBitirmeSüresi/isci_Sayisi;
          System.out.println("cokluBitirmeSüresi = " + cokluBitirmeSüresi);
