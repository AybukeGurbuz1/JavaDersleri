...
public class C09_WhileLoop {
    ...
    */
        ...
        String sifre = "";
        boolean sifreBasriliMi = false;
        int kontrol = 0;

        while (!sifreBasriliMi) {
            // kullanıcıdan bir sifre alalim
            System.out.println("Lutfen bir sifre giriniz");
            sifre = scan.nextLine();
            // 4 kontrolu yapalim, her gecen konterol icin kontrol variable ını bir deger artıralım
            // ilk harf kontrolu
            ...
            if (kontrol==4) {  // tum kontrollerden gecmis demektrş
                System.out.println("sifre basari ile tanimlandi");
                sifreBasriliMi = true;
            }else{  //sifre basarisiz
                    //tekrar basa donecek
                    //kontrol variable ı sifirlanmali
                kontrol=0;
