...
public class Islemler {
    ...
    static List<Kisi> ogrtmnList = new ArrayList<>();   // static yapmamaın sebebi her yerden ulaşmak istediği için
    ...
    public static void girisPaneli() {
        ...
        // cunku kontrol buyuk harfle yapcaz
        switch (secim) {
            case "1":
                kisiTuru = "OGRENCI";
                islemMenusu();
    ...
    private static void ekle() {
        ...
        if (kisiTuru.equals("OGRENCI")) {//TODO sonra doldur
            ...
            scan.nextLine();//dummyy kod hata almamak icin.iki nextline arasına bir dummy hata almamak için
