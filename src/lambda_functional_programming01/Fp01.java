...
public class Fp01 {
    ...
    public static void listElemanlariniYazdirFunctional(List<Integer> list) {
        ...
        // stream() methodu colection dan elementleri akışa dahil etmek için methodlara ulaşmak için kullanılır
    }
    ...
    //2)çift sayi olan çift list elemanlarını aynı satırda aralarında boşluk bırakarak yazdıran bir method oluşturun.(Functional)
    ...
    public static void tekElemanlarinKareleriniYazdir(List<Integer> list) {
        ...
        //elemanlarin değerleri değişecekse map() methodu kullanılır
    }
    ...
    public static void getMinEleman01(List<Integer> list) {
        ...
        System.out.println("min 1.yol :" + min);
    }
    ...
    public static void getMinEleman02(List<Integer> list) {
        ...
        System.out.println("min 2.yol :" + min);
