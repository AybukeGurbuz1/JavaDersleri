...
public class Fp02 {
  ...
  */
    public static void main(String[] args) {
        ...
        tekrarsizCiftElemanlarinKüpününCarpimi(liste);
        getMaxEleman(liste);
        yenidenBuyukCiftMin(liste);
        tersSiralamaylaTekrarsizElmanlarinYarisi(liste);
    ...
    public static void tekrarsizCiftElemanlarinKüpününCarpimi(List<Integer> list) {
    ...
    public static void yenidenBuyukCiftMin(List<Integer> list) {

        Integer min = list.stream().distinct().filter(t -> t > 7).filter(Utils::ciftElemaniSec).reduce(Math::min).get();
        System.out.println(min);
    }

    //10)ters sıralama ile tekrarsız ve 5'ten büyük elemanların yarı değerlerini( elemanların ikiye bölümü)
    //   bulan bir method oluşturun
    public static void tersSiralamaylaTekrarsizElmanlarinYarisi(List<Integer> list){
