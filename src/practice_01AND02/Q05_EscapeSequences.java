...
public class Q05_EscapeSequences {
 /*
    ...
    public static void main(String[] args) {
        ...
        //  Soru-1 :   konsola   "Hello ", "World  \ //"   seklinde yazdiriniz tek kod satırı ile yazdiriniz.
        System.out.println("\"Hello \", \"World \\ // \"");   // interview sorusu

        //  Soru-2 :  Pazartesi kelimesini her harfini ayrı bir satıra gelecek şekilde yazdırın
